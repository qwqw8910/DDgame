...
const WORDS = [
  ...
  // ── 百鬼夜行（作者：zoe・孟澤・Roae・J）weekday_bank: 4 ──────────

  // zoe — 日常概念 / 網路用語 / 日系美食
  { word: '離職',           category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '失眠',           category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '涼皮',           category: '異國料理', difficulty: 'normal', weekday_bank: 4 },
  { word: '石鍋拌飯',       category: '異國料理', difficulty: 'normal', weekday_bank: 4 },
  { word: '槍火',           category: '電影卡通', difficulty: 'hard',   weekday_bank: 4 },
  { word: '好朋友的祝福',   category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '沉香',           category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '香水',           category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: '精油',           category: '日常物品', difficulty: 'normal', weekday_bank: 4 },
  { word: '水晶',           category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: '黑曜石',         category: '日常物品', difficulty: 'normal', weekday_bank: 4 },
  { word: '和田玉',         category: '日常物品', difficulty: 'hard',   weekday_bank: 4 },
  { word: '搶票',           category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '社恐',           category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '活動菇',         category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '開圖鑑',         category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '明信片',         category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: '閃退',           category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '棄坑',           category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '拖延症',         category: '概念',     difficulty: 'easy',   weekday_bank: 4 },

  // 孟澤 — 動漫梗 / 遊戲 / 武俠
  { word: '渡劫',           category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '金鐘罩',         category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '火云邪神',       category: '電影卡通', difficulty: 'hard',   weekday_bank: 4 },
  { word: '馬卡龍',         category: '異國料理', difficulty: 'easy',   weekday_bank: 4 },
  { word: '原神啟動',       category: '電影卡通', difficulty: 'normal', weekday_bank: 4 },
  { word: '單身狗',         category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '海綿寶寶',       category: '電影卡通', difficulty: 'easy',   weekday_bank: 4 },
  { word: '派大星',         category: '電影卡通', difficulty: 'easy',   weekday_bank: 4 },
  { word: '哥布林',         category: '電影卡通', difficulty: 'normal', weekday_bank: 4 },
  { word: '富士山',         category: '地名',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '刮鬍刀',         category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: '娃娃機',         category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: '手榴彈',         category: '日常物品', difficulty: 'normal', weekday_bank: 4 },
  { word: '薛之谦',         category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '皮克敏',         category: '電影卡通', difficulty: 'normal', weekday_bank: 4 },
  { word: '梁山伯與茱麗葉', category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '唐三藏',         category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '蘿莉控',         category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '殭屍',           category: '電影卡通', difficulty: 'easy',   weekday_bank: 4 },
  { word: '惡龍咆嘯',       category: '概念',     difficulty: 'hard',   weekday_bank: 4 },

  // Roae — 音樂 / 台灣生活 / 成語
  { word: '電扶梯',         category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: '小籠湯包',       category: '台灣美食', difficulty: 'easy',   weekday_bank: 4 },
  { word: '鼎泰豐',         category: '台灣美食', difficulty: 'easy',   weekday_bank: 4 },
  { word: '釣竿',           category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: '七嘴八舌',       category: '成語',     difficulty: 'normal', weekday_bank: 4 },
  { word: '獵魔女團',       category: '電影卡通', difficulty: 'hard',   weekday_bank: 4 },
  { word: '四月是你的謊言', category: '電影卡通', difficulty: 'normal', weekday_bank: 4 },
  { word: '王力宏',         category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '臺北火車站',     category: '地名',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '貝多芬',         category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '小提琴',         category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: '大提琴',         category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: '鋼琴',           category: '日常物品', difficulty: 'easy',   weekday_bank: 4 },
  { word: 'YAMAHA',         category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '郎朗',           category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '五線譜',         category: '日常物品', difficulty: 'normal', weekday_bank: 4 },
  { word: '直笛',           category: '日常物品', difficulty: 'normal', weekday_bank: 4 },
  { word: '悠游卡',         category: '台灣特色', difficulty: 'easy',   weekday_bank: 4 },
  { word: '一丘之貉',       category: '成語',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '神愛世人',       category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '全家便利商店',   category: '台灣特色', difficulty: 'easy',   weekday_bank: 4 },
  { word: '唯唯諾諾',       category: '成語',     difficulty: 'normal', weekday_bank: 4 },

  // J — 軍事 / 動漫 / 台灣政治 / 飲食
  { word: '戰備口糧',       category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '漢光演習',       category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '顧立雄',         category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '空降部隊',       category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '玩具總動員',     category: '電影卡通', difficulty: 'easy',   weekday_bank: 4 },
  { word: '王品牛排',       category: '台灣特色', difficulty: 'normal', weekday_bank: 4 },
  { word: '跳傘',           category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '焚風',           category: '概念',     difficulty: 'hard',   weekday_bank: 4 },
  { word: '龍捲風',         category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '蠶寶寶',         category: '動物',     difficulty: 'normal', weekday_bank: 4 },
  { word: '鐵板麵',         category: '台灣美食', difficulty: 'normal', weekday_bank: 4 },
  { word: '望梅止渴',       category: '成語',     difficulty: 'normal', weekday_bank: 4 },
  { word: '銀魂',           category: '電影卡通', difficulty: 'normal', weekday_bank: 4 },
  { word: '口蜜腹劍',       category: '成語',     difficulty: 'normal', weekday_bank: 4 },
  { word: '海軍陸戰隊',     category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '海賊王',         category: '電影卡通', difficulty: 'easy',   weekday_bank: 4 },
  { word: '馬英九',         category: '概念',     difficulty: 'easy',   weekday_bank: 4 },
  { word: '民意調查',       category: '概念',     difficulty: 'normal', weekday_bank: 4 },
  { word: '曼陀珠',         category: '日常物品', difficulty: 'hard',   weekday_bank: 4 },
  { word: '花王洗髮精',     category: '日常物品', difficulty: 'hard',   weekday_bank: 4 },
];
